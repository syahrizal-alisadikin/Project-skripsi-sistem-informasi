    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header">
              <a href="{{ route('instruktur.create') }}" class="btn btn-success">Tambah Instruktur</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td>{{ $loop->iteration }}</td>
                                    ...
                                    <td>{{ $item->status }}</td>
                                    <td>
                                         <a href="{{ route('instruktur.edit' , $item->id) }}" class="btn btn-sm btn-info">
